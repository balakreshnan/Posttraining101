...
Validated: a 150-step run on hecate took ~3 minutes and went from 54%
to 100% greedy accuracy, with code/weights/HF cache all kept on Lustre
(`/lustre/fsw/general_sa/bbalakreshna/rlvr-posttraining101`), submitted
from the login-node home directory via the account's existing
